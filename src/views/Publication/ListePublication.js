...
class Tables extends Component {
  ...
  getAllSociete(){
    ...
    fetch("http://localhost:8080/publication/all",{method:"GET"})
  ...
  remove(id){
    fetch("http://localhost:8080/publication/delete/"+id,{method:"DELETE"})
      .then(response => response.json())
      .then(data => {
  ...
  handleClickEdit(e,id){
    ...
    window.location.href="/#/home/modifpublication"
